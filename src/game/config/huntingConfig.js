...
export const HERO_DISPLAY_SIZE = 28; // desired on-screen size per axis
export const HERO_SCALE = HERO_DISPLAY_SIZE / HERO_FRAME_SIZE; // e.g., 16/64 = 0.25

// Collider tuning per size
export const HERO_COLLIDER_SIZE = TILE_SIZE === 16 ? 12 : 20;
export const HERO_COLLIDER_OFFSET = TILE_SIZE === 16 ? { x: 2, y: 4 } : { x: 6, y: 8 };
