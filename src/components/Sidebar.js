      ...
      <div className="sidebar-inner">
        <nav>
          <ul>
            ...
            <li>
              <a href="/home-ver2" className="sidebar-nav-link sidebar-nav-link--badge">
                <span className="sidebar-nav-link__badge-wrap">
                  <img src="/images/buttons/homepage.png" alt="homepage"/>
                  {hasAnyAlert && (
