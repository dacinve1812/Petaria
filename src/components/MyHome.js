    ...
    <div className="myhome-page">
      ...
      <div className="myhome-main">
        ...
        {selectedOption === 'pet' ? (
          ...
          <SpiritManagement userId={userId} />
        )}
      </div>
    </div>
  );
...
function PetManagement({ userPets, isLoading, imageLoadErrors, setImageLoadErrors }) {
    ...
    <div className="pet-management">
      ...
      <div className="pet-container">
        {isLoading ? (
          ...
          <div className="pets-grid" key={`pet-${currentPage}-${searchTerm}-${filterType}-${sortOption}`}>
